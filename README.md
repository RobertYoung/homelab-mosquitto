...
Ansible project for deploying [Mosquitto](https://mosquitto.org/) MQTT broker via Docker Compose on a single host.

**Target host:** `mosquitto.local.iamrobertyoung.co.uk`
...
├── inventories/
│   ├── hosts.yml               # Inventory with mosquitto group
│   └── group_vars/             # Group variables
├── host_vars/                  # Host-specific variables
├── roles/
│   └── mosquitto/              # Custom Mosquitto role
...
| `mosquitto` | Custom | Mosquitto MQTT broker deployment |
